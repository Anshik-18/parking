...
function SearchResultContent() {
    ...
    const [parkingLots, setParkingLots] = useState<ParkingLotWithLocation[]>([]);
    ...
    const handleMarkerClick = (i: number, lot: ParkingLotWithLocation) => {
      setActiveMarker(i);
      if (map) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {parkingLots.map((lot, i) => (
                    ...
                    >
                        ...
                        <div className="pt-4">
                            <Button onClick={() => handleClick(lot)}>
                                Book now
                            </Button>
                        </div>
                    </div>
